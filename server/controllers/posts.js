...
export const likePost = async (req,res) => {
    ...
    const updatedPost = await PostMessage.findByIdAndUpdate(id, {likeCount: post.likeCount + 1 }, {new: true} );/** {new : true} This option causes it to return the updated document after the update process is complete. */
